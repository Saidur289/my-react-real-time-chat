...
const Chat = () => {
    ...
    return (
        <div className='flex h-[100vh] text-white overflow-hidden'>
            {
                isUploading && (<div className='w-[100wh] h-[100vh] fixed top-0 z-10 left-0 bg-black/80 flex items-center justify-center flex-col gap-5 backdrop-blur-lg '>
                    <h1 className='text-5xl animate-pulse'>Uploading File</h1>
                    {fileUploadProgress}
                </div>)
            }
            {
                isDownloading && (<div className='w-[100wh] h-[100vh] fixed top-0 z-10 left-0 bg-black/80 flex items-center justify-center flex-col gap-5 backdrop-blur-lg '>
